...
export default async function ConsulatesPage({ searchParams }: Props) {
  ...
  const alerts = await getAggregatedAlerts({ categories: ["ADMINISTRATIVE"], limit: 6 });
