...
export default async function ShopDetailPage({ params }: ShopDetailProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-5xl flex-1 px-6 py-10">
      <Breadcrumb items={[{ label: "Home", href: "/" }, { label: "Shops", href: "/shops" }, { label: shop.name }]} />
      ...
      <section className="mt-10">
        ...
        {shop.products.length === 0 ? <p className="mt-4 text-sm text-slate-500">No published products yet.</p> : (
