...
export const GABON_DIRECT_TERMS = [
  ...
  "anbg", "dgbc", "ministere", "presidence", "republique gabonaise", "ambassade du gabon", "consulat du gabon", "assemblee nationale", "senat", "cnss", "caisse nationale de securite sociale", "air gabon", "totalenergies gabon", "comilog", "bdg", "gabon telecom",
...
export const DIASPORA_TERMS = ["diaspora", "communaute gabonaise", "etudiants gabonais", "gabonais de", "amicale gabonaise", "association des gabonais", "ressortissants gabonais", "gabonais a l'etranger", "retour au gabon"] as const;
