...
function getSupabaseUrl(): string {
  ...
  if (!value) throw new Error("A Supabase URL must be defined in the environment.");
  return value;
}
...
function getSupabaseAnonKey(): string {
  ...
  if (!value) throw new Error("A Supabase publishable key must be defined in the environment.");
  return value;
}
